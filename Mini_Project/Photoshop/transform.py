...
if __name__ == '__main__':
    ...
    # brightening
    brightened_im = brighten(city, 1.7)
    brightened_im.write_image('brightened.png')

    brighten_image = brighten(city, 1.7)
    brighten_image.write_image('bright.png')
